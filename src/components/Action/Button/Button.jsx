...
export const variantsColors = {
	contained: {
		...
		secondary:
			'bg-gray-200 text-slate-800 enabled:hover:bg-gray-300 dark:bg-gray-700 dark:enabled:hover:bg-gray-800 dark:text-white',
	...
	text: {
		...
		secondary:
			'bg-transparent text-slate-800 dark:bg-transparent dark:text-dark-100 hover:text-slate-700 dark:hover:text-dark-50',
